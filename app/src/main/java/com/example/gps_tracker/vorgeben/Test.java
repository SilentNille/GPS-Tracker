...
public class Test {
  ...
  public static void main(String[] args) {
     ...
     * 
     * The distance() function takes a reference to a com.example.gps_tracker.vorgeben.LatLng object as a
    ...
    /*
     * Convert Six-Figure OS Grid Reference String to an com.example.gps_tracker.OSRef Object
     * 
     * To convert a string representing a six-figure OSGB grid reference:
     */

    System.out
        .println("Convert Six-Figure OS Grid Reference String to an com.example.gps_tracker.OSRef Object");
    String os6 = "TG514131";
